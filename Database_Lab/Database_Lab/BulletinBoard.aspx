<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulletinBoard.aspx.cs" Inherits="Database_Lab.BulletinBoard" %>
...
<body>
    <form id="form1" runat="server">
     ...
     HeaderStyle-CssClass="header" RowStyle-CssClass="rows" AllowPaging="True" OnPageIndexChanging="datagrid_PageIndexChanging">
            ...
            <div>
                <asp:Label ID="announcer_lbl" runat="server" Text="Name:"></asp:Label>
                <br/>
                <asp:TextBox ID="announcer" runat="server" Width="50%" placeholder="Name"></asp:TextBox>
                <br/>
                <asp:Label ID="title_lbl" runat="server" Text="Title:"></asp:Label>
                <br/>
                <asp:TextBox ID="title_tb" runat="server" Width="50%" placeholder="please input title"></asp:TextBox>
                <br/>
                <asp:Label ID="txtinput_lbl" runat="server" Text="Content:"></asp:Label>
                <br/>
                <asp:TextBox ID="txtInput_tb" runat="server" Width="50%" placeholder="please input bulletin"></asp:TextBox>
                <br/>
